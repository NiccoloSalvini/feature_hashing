...
```
    ...
    ## Downloading data from: https://github.com/topepo/FES/blob/master/Data_Sets/OkCupid/okc.RData?raw=True

    ## SHA-1 hash of the downloaded data file is:
    ## 205847a7dddb70eb9c181d0f0f084ceb5edb10e2
...
```
    ...
    ## 51 x 16 sparse Matrix of class "dgCMatrix"
